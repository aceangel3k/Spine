...
ig.TouchButtonCollection = ig.Class.extend({
	...
	init: function( buttons ) {
		...
		var igCanvas = ig.system.canvas;
		igCanvas.addEventListener('touchstart', this.touchStart.bind(this), false);
		igCanvas.addEventListener('touchend', this.touchEnd.bind(this), false);
		igCanvas.addEventListener('MSPointerDown', this.touchStartMS.bind(this), false);
		igCanvas.addEventListener('MSPointerUp', this.touchEndMS.bind(this), false);
